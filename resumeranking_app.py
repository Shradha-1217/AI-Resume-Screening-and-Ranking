        ...
        if resumes:
            ...
            if show_skills and SPACY_AVAILABLE:
                ...
                for i in ranked_indices:
                    ...
                    skills_list.append(list(skills) if skills else ["No key skills detected"])
            ...
            if not top_results.empty:
                ...
                fig, ax = plt.subplots(figsize=(10, len(top_results) * 0.5), constrained_layout=True)
            ...
            with st.expander("View Detailed Resume Matches"):
                for idx, row in top_results.iterrows():
                    ...
                    highlighted_text = resume_text[:500]
                    for keyword in job_description.split()[:10]:
                        highlighted_text = re.sub(f"\\b({keyword})\\b", r"<mark>\1</mark>", highlighted_text, flags=re.IGNORECASE)
            ...
            if export_format == "CSV":
                ...
                st.markdown(f'<a href="data:file/csv;base64,{b64}" download="resume_ranking.csv">Download CSV</a>', unsafe_allow_html=True)
